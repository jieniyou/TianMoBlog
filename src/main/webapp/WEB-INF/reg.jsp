...
<div class="login-wrapper layui-anim layui-anim-scale layui-hide">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            <a href="login.jsp" class="layui-link">Return Login</a>
        </div>
        <div class="layui-form-item" style="margin-bottom: 20px;">
            <button class="layui-btn layui-btn-fluid" lay-filter="loginSubmit" lay-submit>SIGN UP</button>
        </div>
    </form>
</div>
...
<script>
    layui.use(['layer', 'form', 'formX'], function () {
        ...
        form.on('submit(loginSubmit)', function (obj) {
            ...
            $.post('/user/reg', obj.field, function (res) {
